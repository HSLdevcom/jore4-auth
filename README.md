...
Runs frontend and auth through nginx proxy that maps UI to localhost:3301/ and auth to localhost:3301/api/auth
...
The application uses sprint boot which allows overwriting configuration properties as described
