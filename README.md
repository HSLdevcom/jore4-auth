...
| spring.datasource.url      | SPRING_DATASOURCE_URL      | spring-datasource-url      | jdbc:postgresql://postgres-host:5432/auth_session_db | Persistent session database connection URL |
