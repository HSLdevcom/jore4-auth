...
class OIDCCodeExchangeApiController(
    ...
    fun exchangeCode(
            ...
            @RequestParam
            code: String,
            @Parameter(description = "The state to verify the requests authenticity (the state has been generated by us before invoking the OIDC provider's login endpoint).")
            @RequestParam
            state: String,
            session: HttpSession
    ): ResponseEntity<Void> {
